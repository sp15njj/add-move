...
// 		this.div = $id('msg');
	...
	slide(){
		for(let i = 0;i < this.num;i ++){
			...
			this.ullis[i].style.display = 'none';
			//圆点
			this.ollis[i].style.background = '#d9d9d9';
		}
		//当前大图
		this.ullis[this.indexA].style.display = 'block';
		//当前圆点
		this.ollis[this.indexA].style.backgroundColor = '#ff4f13';
...
// 			this.ullis[i].style.display = 'none';
// 			//圆点
// 			this.ollis[i].style.background = '#737373';
// 		}
// 		//当前大图
// 		this.ullis[this.indexA].style.display = 'block';
// 		//当前圆点
// 		this.ollis[this.indexA].style.backgroundColor = '#ff6600';
// 		
// 	}
 	addEvent(){
